...
namespace StationService
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Pompe pompeCamion = new Pompe(Vehicule.Camion, pistoletsCamion);
            Pompe pompeVoiture = new Pompe(Vehicule.Autres, pistoletsVoiture);
            Pompe pompeVelomoteur = new Pompe(Vehicule.Velomoteur, pistoletsVelomoteur);
